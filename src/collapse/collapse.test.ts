import { collapseRecurse, collapseStack } from "./collapse"

describe('Testing collapse', () => {
    it("Shuld return 'null' when input value is null", () => {
        expect(collapseStack(null)).toBeNull()
        expect(collapseRecurse(null)).toBeNull()
    })
    ...
    describe('should flat object with one level', () => {
        it('Should work with numbers', () => {
            ...
            for (const example of examples) {
                expect(collapseStack(example.test)).toEqual(example.result)
                expect(collapseRecurse(example.test)).toEqual(example.result)
            }
        })
        ...
        it('Should work with null', () => {
            const examples = [
                {test: {a: null}, result: {a: null}},
                {test: {key1: 10, key2: null}, result: {key1: 10, key2: null}},
            ]
    ...
    describe('should flat object with more than one depth level', () => {
        ...
        it('Should work with arrays', () => {
            const examples = [
                ...
                {test: {a: {c: [10, 20]}, b: {d: [50, 20], e: {j: ['qwerty', 20]}}}, result: {'a.c.0': 10, 'a.c.1': 20, 'b.d.0': 50, 'b.d.1': 20, 'b.e.j.0': 'qwerty', 'b.e.j.1': 20}},
            ]
        ...
        it('Should work with strings', () => {
            const examples = [
                ...
                {test: {a: 'qwerty', b: '12345', c: {'': {j: 'rtyu', t: 'text'}, e: 'some'}}, result: {a: 'qwerty', b: '12345', 'c..j': 'rtyu', 'c..t': 'text', 'c.e': 'some'}},
            ]
        ...
        it('Should work with null', () => {
            const examples = [
                {test: {a: {b: 'qwerty', c: null}}, result: {'a.b': 'qwerty', 'a.c': null}},
                {test: {a: 'qwerty', b: '12345', c: {d: {j: 'rtyu', t: null}, e: 'some'}}, result: {a: 'qwerty', b: '12345', 'c.d.j': 'rtyu', 'c.d.t': null, 'c.e': 'some'}},
            ]
